...
# 从 config 获取路径（保持环境变量可覆盖）
from config import DB_PATH, CSV_PATH, MODEL_CACHE_DIR
OUTPUT_JSON = os.environ.get("STOCK5_OUTPUT", os.path.join(_v6_dir, "result_v5.json"))
