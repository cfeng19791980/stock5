...
# 任务1：上午12:00 LLM分析
$Action1 = New-ScheduledTaskAction -Execute "python" -Argument "E:\stock5\llm_analyzer_minute.py" -WorkingDirectory "E:\stock5"
...
# 任务2：下午15:00 LLM分析
$Action2 = New-ScheduledTaskAction -Execute "python" -Argument "E:\stock5\llm_analyzer_minute.py" -WorkingDirectory "E:\stock5"
