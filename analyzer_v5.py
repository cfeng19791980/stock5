...
def train_models_v5(stock_pool, conn):
    ...
    for code in stock_pool:
        try:
            ...
            # XGBoost (优化: 低学习率+更多树+早停)
            xgb_model = xgb.XGBClassifier(
                n_estimators=500, max_depth=3, random_state=42, verbosity=0,
                learning_rate=0.01, min_child_weight=4, subsample=0.75,
            ...
            # CatBoost (优化: 低学习率+更多树+早停)
            cat_model = CatBoostClassifier(
                iterations=500, depth=3, random_state=42, verbose=False,
                learning_rate=0.01, min_child_samples=4, subsample=0.75,
