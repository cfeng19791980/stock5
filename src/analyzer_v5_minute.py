...
# 配置
DB_PATH = os.path.join(PROJECT_DIR, 'stocks.db')
MODEL_CACHE_DIR = os.path.join(PROJECT_DIR, 'model_cache_v5')
OUTPUT_JSON = os.path.join(PROJECT_DIR, 'result_v5_minute.json')
STOCK_CODES = [
